          ...
          <div className="flex-1 overflow-y-auto p-6">
            {checkoutStep === "cart" ? (
              ...
              <form onSubmit={(e) => e.preventDefault()} className="space-y-5">
                ...
                <div>
                  <label className="block text-xs font-black uppercase tracking-wider text-zinc-700 dark:text-zinc-300 mb-1.5">
                    Delivery Location / Landmark * <p className="text-[10px] text-zinc-400 mt-1">Kindly note that your order will be delivered to the landmark specified during the checkout process.
</p>
                  </label>
                  <select
