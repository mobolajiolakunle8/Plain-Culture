...
export const CartAndCheckoutDrawer: React.FC<CartAndCheckoutDrawerProps> = ({
  ...
  const handleProofChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file.size > 5 * 1024 * 1024) {
      onAddToast("File size must be under 5MB.", "error");
      return;
    }
                ...
                <div className="pt-4 border-t border-zinc-200 dark:border-zinc-900">
                  ...
                  <div className="relative">
                    ...
                    <label
                      ...
                      className="flex flex-col items-center justify-center p-6 border-2 border-dashed border-zinc-300 dark:border-zinc-700 rounded-sm hover:border-[#E8FF6B] hover:bg-[#E8FF6B]/5 transition-colors cursor-pointer"
                    >
                      {proofPreview ? (
                        <div className="relative w-full max-h-40 flex items-center justify-center">
                          <img src={proofPreview} alt="Proof preview" className="max-h-40 object-contain rounded" />
                        ...
                        <div className="text-center">
                          ...
                          <span className="text-xs text-zinc-500">Tap to upload receipt screenshot</span>
                          <span className="block text-[10px] text-zinc-400 mt-1">JPG, PNG up to 5MB</span>
                        </div>
                      )}
                    </label>
                  </div>
                  <p className="text-[10px] text-zinc-400 mt-2">Uploading proof helps verify your payment faster.</p>
                </div>
              </form>
            ) : (
