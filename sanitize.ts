...
const DEFAULT_SETTINGS = {
  ...
  deliveryZones: [
    ...
    { id: "dz-3",  landmark: "Bodija Estate",                   fee: 1000, lat: 7.4300, lng: 3.9100 },
    { id: "dz-4",  landmark: "Agodi / Agodi Gate",              fee: 1000, lat: 7.4000, lng: 3.9100 },
    { id: "dz-5",  landmark: "Aleshinloye / Mokola",            fee: 1200, lat: 7.3950, lng: 3.9050 },
    { id: "dz-6",  landmark: "Ring Road / Dugbe",               fee: 1500, lat: 7.3886, lng: 3.9093 },
    { id: "dz-7",  landmark: "Secretariat / Challenge",         fee: 1500, lat: 7.3900, lng: 3.9200 },
    { id: "dz-8",  landmark: "Iwo Road / New Garage",           fee: 1500, lat: 7.3950, lng: 3.9300 },
    { id: "dz-9",  landmark: "Ojoo / Iwo Road Express",         fee: 1500, lat: 7.4500, lng: 3.9300 },
    { id: "dz-10", landmark: "Akobo / Akobo Ojurin",            fee: 2000, lat: 7.4333, lng: 3.9500 },
    { id: "dz-11", landmark: "Ajibode / Akobo Basin",           fee: 2000, lat: 7.4400, lng: 3.9600 },
    { id: "dz-12", landmark: "Oluyole / Adamasingba",           fee: 1500, lat: 7.3600, lng: 3.9100 },
    { id: "dz-13", landmark: "Apata / Abule Ijebu",             fee: 1500, lat: 7.3500, lng: 3.9200 },
    { id: "dz-14", landmark: "Sango / Eleyele",                 fee: 1500, lat: 7.4100, lng: 3.8800 },
    { id: "dz-15", landmark: "Iyaganku / Jericho",              fee: 1200, lat: 7.4050, lng: 3.9000 },
    { id: "dz-16", landmark: "Samonda / Ashi",                  fee: 1200, lat: 7.4200, lng: 3.9100 },
    { id: "dz-17", landmark: "Eleiyele / Basorun",              fee: 1500, lat: 7.4000, lng: 3.8900 },
    { id: "dz-18", landmark: "Alao Akala / Toll Gate",          fee: 1500, lat: 7.3700, lng: 3.8800 },
    { id: "dz-19", landmark: "Egbeda / Awotan",                 fee: 2000, lat: 7.4200, lng: 3.8500 },
    { id: "dz-20", landmark: "Akala / Olunde",                  fee: 2000, lat: 7.3600, lng: 3.8700 },
    { id: "dz-21", landmark: "Moniya / Apete",                  fee: 2000, lat: 7.5000, lng: 3.9000 },
    { id: "dz-22", landmark: "Beere / Oja Oba",                 fee: 1500, lat: 7.3850, lng: 3.9050 },
    { id: "dz-23", landmark: "Orita / Oke-Bola",                fee: 1500, lat: 7.3800, lng: 3.9100 },
    { id: "dz-24", landmark: "Yemetu / Oke-Ado",                fee: 1500, lat: 7.3850, lng: 3.9000 },
    { id: "dz-25", landmark: "Oke-Padre / Odo-Ona",             fee: 1500, lat: 7.3750, lng: 3.9300 },
    { id: "dz-26", landmark: "Ido / Ido Station",               fee: 2000, lat: 7.4500, lng: 3.8500 },
    { id: "dz-27", landmark: "Kabba Road / Idi-Ape",            fee: 2000, lat: 7.3900, lng: 3.9400 },
    { id: "dz-28", landmark: "Agugu / Oremeji",                 fee: 2000, lat: 7.3700, lng: 3.9500 },
    { id: "dz-29", landmark: "Olodo / Elebu",                   fee: 2500, lat: 7.3400, lng: 3.9000 },
    { id: "dz-30", landmark: "Other State (WhatsApp Quote)",    fee: -1,   lat: 0,      lng: 0      }
  ]
};
...
export const dbService = {
  ...
  uploadPaymentProof: async (file: File, orderId: string): Promise<string> => {
    ...
    const storageRef = ref(storage, `payment_proofs/${orderId}.jpg`);
  ...
  updatePaymentStatus: async (id: string, status: "Pending" | "Verified" | "Rejected"): Promise<void> => {
    const orders = mockDb.getData("orders");
    const index = orders.findIndex((o) => o.id === id);
    if (index !== -1) {
    ...
    if (isFirebaseConfigured && db) {
      try {
        ...
        console.error("Firebase updatePaymentStatus error:", e);
      }
    }
  },
